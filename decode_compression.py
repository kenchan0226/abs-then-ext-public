...
from decoding import CompressionControlAbstractor, BeamCompressionControlAbstractor
...
def decode(save_path, abs_dir, split, batch_size, beam_size, diverse, max_len, topk, rerank_mode, keep_original_sent, start_idx, cuda, n_compression_levels, debug=False):
    start = time()
    # setup model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_compression_levels', type=int, action='store', default=0,
                        help='The number of compression levels')
    ...
    decode(args.path, args.abs_dir,
           ...
           args.max_dec_word, args.topk, args.rerank_mode, keep_original_sentence, args.start_idx, args.cuda, args.n_compression_levels, args.debug)
