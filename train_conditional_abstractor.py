...
from data.batcher import coll_fn_cond_gen, prepro_fn_cond
from data.batcher import convert_batch_copy_cond, batchify_fn_copy_cond
from data.batcher import BucketedGenerater

from utils import PAD, UNK, START, END
from utils import make_vocab, make_vocab_cond, make_embedding
...
class ConditionalMatchDataset(CnnDmDataset):
    """ single article sentence -> single abstract sentence
    (dataset created by greedily matching ROUGE)
    """
