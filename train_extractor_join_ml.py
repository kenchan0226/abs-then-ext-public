...
from model.extract import ExtractSumm, PtrExtractSumm, PtrExtractRewrittenSumm
...
def build_batchers(net_type, word2id, cuda, train_set_folder, valid_set_folder, debug, auto_stop=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--abs_path', required=True, help='root of the abstractor model')
    ...
    parser.add_argument('--abstractor_hidden', type=int, action='store', default=256,
                        help='the number of hidden units of lSTM')
